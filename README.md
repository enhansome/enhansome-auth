...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,696 | 🐛 120 | 🌐 Go | 📅 2026-08-26 - The Single Sign-On Multi-Factor portal for web apps.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,856 | 🐛 1,135 | 🌐 Go | 📅 2026-08-26 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Logto](https://github.com/logto-io/logto) ⭐ 14,462 | 🐛 178 | 🌐 TypeScript | 📅 2026-08-26 - An IAM infrastructure with AuthN, AuthZ, MFA, SSO, user management, and multi-tenancy features, supporting OAuth 2.0, OIDC, and SAML.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,270 | 🐛 108 | 🌐 Go | 📅 2026-08-25 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [NanoIDP](https://github.com/cdelmonte-zg/nanoidp) ⭐ 22 | 🐛 17 | 🌐 Python | 📅 2026-08-25 - Local development Identity Provider for testing OAuth2, OpenID Connect, and SAML flows without running a full IAM stack.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,495 | 🐛 94 | 🌐 Go | 📅 2026-07-29 - OpenID Connect certified OAuth2 server.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,856 | 🐛 1,135 | 🌐 Go | 📅 2026-08-26 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,270 | 🐛 108 | 🌐 Go | 📅 2026-08-25 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [Ory Kratos](https://github.com/ory/kratos) ⭐ 13,847 | 🐛 224 | 🌐 Go | 📅 2026-07-29 - API-first Identity and User Management system built for cloud applications.
...
* [OIDC](https://github.com/caos/oidc) ⭐ 1,872 | 🐛 39 | 🌐 Go | 📅 2026-08-25 - OpenID Connect Library (client and server) for Go
...
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,452 | 🐛 7 | 🌐 Java | 📅 2026-08-25 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
* [pac4j](https://github.com/pac4j/pac4j) ⭐ 2,520 | 🐛 4 | 🌐 Java | 📅 2026-08-26 - Security engine for Java (authentication, authorization, multi frameworks): OAuth, CAS, SAML, OpenID Connect, LDAP, JWT.
...
* [client-certificate-auth](https://github.com/tgies/client-certificate-auth) ⭐ 80 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-25 - Mutual TLS (mTLS) client certificate authentication middleware for Node.js with reverse proxy support, composable verification callbacks, and X.509 certificate parsing.
...
* [Python Social Auth](https://github.com/python-social-auth/social-core) ⭐ 919 | 🐛 55 | 🌐 Python | 📅 2026-08-25 - Easy to setup social authentication/registration mechanism with support for several frameworks and auth providers.
* [Keystone](https://github.com/openstack/keystone) ⭐ 717 | 🐛 0 | 🌐 Python | 📅 2026-08-25 - Provides authentication, authorization and service discovery mechanisms via HTTP primarily for use by projects in the OpenStack family.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,554 | 🐛 60 | 🌐 Go | 📅 2026-08-26 - Open-source authorization layer with a .NET SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,346 | 🐛 38 | 🌐 Go | 📅 2026-08-21 - Authorization library that supports access control models like ACL, RBAC, ABAC in Golang.
* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,856 | 🐛 1,135 | 🌐 Go | 📅 2026-08-26 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,990 | 🐛 151 | 🌐 Go | 📅 2026-08-24 - Open-source implementation of the Zanzibar paper, a performant database for fine-grained permissions.
* [Ory Keto](https://github.com/ory/keto) ⭐ 5,389 | 🐛 73 | 🌐 Go | 📅 2026-08-24 - Access control server capable of solving complex use cases (multi-tenant, attribute-based access control, etc.) with access control policies.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,554 | 🐛 60 | 🌐 Go | 📅 2026-08-26 - Open-source authorization layer with a Go SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [OIDC](https://github.com/zitadel/oidc) ⭐ 1,872 | 🐛 39 | 🌐 Go | 📅 2026-08-25 - OpenID Connect Library (client and server) for Go
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,554 | 🐛 60 | 🌐 Go | 📅 2026-08-26 - Open-source authorization layer with a Rust SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,554 | 🐛 60 | 🌐 Go | 📅 2026-08-26 - Open-source authorization layer with a Java SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,452 | 🐛 7 | 🌐 Java | 📅 2026-08-25 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,554 | 🐛 60 | 🌐 Go | 📅 2026-08-26 - Open-source authorization layer with a JavaScript/Node.js SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [pundit-ts](https://github.com/fatihky/pundit-ts) ⭐ 97 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Fully type-safe authorization library inspired by awesome [pundit](https://github.com/varvet/pundit) ⭐ 8,522 | 🐛 15 | 🌐 Ruby | 📅 2026-08-02 gem. Can be used for RBAC, ABAC access control models or any other model you wish.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,554 | 🐛 60 | 🌐 Go | 📅 2026-08-26 - Open-source authorization layer with a PHP SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,554 | 🐛 60 | 🌐 Go | 📅 2026-08-26 - Open-source authorization layer with a Python SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [CanCanCan](https://github.com/CanCanCommunity/cancancan) ⭐ 5,686 | 🐛 93 | 🌐 Ruby | 📅 2026-08-09 - Authorization for Ruby on Rails.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,554 | 🐛 60 | 🌐 Go | 📅 2026-08-26 - Open-source authorization layer with a Ruby SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Composio](https://github.com/ComposioHQ/composio) ⭐ 29,880 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-26 - Hosted integration platform with managed OAuth and tool calling for 1000+ apps.
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,597 | 🐛 109 | 🌐 TypeScript | 📅 2026-08-25 - Open-source OAuth and API key handling for 700+ APIs with token refresh and a unified API for agent workloads.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,554 | 🐛 60 | 🌐 Go | 📅 2026-08-26 - Open-source, policy-based authorization for AI agents, agentic workflows, and MCP servers, with fine-grained access control and full decision logging at runtime.
* [Arcade](https://github.com/ArcadeAI/arcade-ai) ⭐ 1,010 | 🐛 24 | 🌐 Python | 📅 2026-08-25 - Tool-calling platform with user approvals and authenticated actions for AI agents.
...
This project is licensed under the [CC0-1.0 license](https://github.com/casbin/awesome-auth/blob/master/LICENSE) ⭐ 1,215 | 🐛 5 | 🌐 Go | 📅 2026-08-25.
