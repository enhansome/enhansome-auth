...
* [pac4j](https://github.com/pac4j/pac4j) ⭐ 2,521 | 🐛 1 | 🌐 Java | 📅 2026-08-27 - Security engine for Java (authentication, authorization, multi frameworks): OAuth, CAS, SAML, OpenID Connect, LDAP, JWT.
...
* [client-certificate-auth](https://github.com/tgies/client-certificate-auth) ⭐ 80 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-27 - Mutual TLS (mTLS) client certificate authentication middleware for Node.js with reverse proxy support, composable verification callbacks, and X.509 certificate parsing.
...
* [Python Social Auth](https://github.com/python-social-auth/social-core) ⭐ 919 | 🐛 55 | 🌐 Python | 📅 2026-08-27 - Easy to setup social authentication/registration mechanism with support for several frameworks and auth providers.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 59 | 🌐 Go | 📅 2026-08-27 - Open-source authorization layer with a .NET SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [OIDC](https://github.com/zitadel/oidc) ⭐ 1,873 | 🐛 39 | 🌐 Go | 📅 2026-08-27 - OpenID Connect Library (client and server) for Go
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 59 | 🌐 Go | 📅 2026-08-27 - Open-source authorization layer with a Rust SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 59 | 🌐 Go | 📅 2026-08-27 - Open-source authorization layer with a Java SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,452 | 🐛 7 | 🌐 Java | 📅 2026-08-25 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 59 | 🌐 Go | 📅 2026-08-27 - Open-source authorization layer with a JavaScript/Node.js SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [pundit-ts](https://github.com/fatihky/pundit-ts) ⭐ 97 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-22 - Fully type-safe authorization library inspired by awesome [pundit](https://github.com/varvet/pundit) ⭐ 8,522 | 🐛 13 | 🌐 Ruby | 📅 2026-08-27 gem. Can be used for RBAC, ABAC access control models or any other model you wish.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 59 | 🌐 Go | 📅 2026-08-27 - Open-source authorization layer with a PHP SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 59 | 🌐 Go | 📅 2026-08-27 - Open-source authorization layer with a Python SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Flask-RBAC](https://github.com/shonenada/flask-rbac) ⭐ 233 | 🐛 15 | 🌐 Python | 📅 2026-02-20 - Adds RBAC support to [Flask](https://github.com/pallets/flask) ⭐ 72,142 | 🐛 3 | 🌐 Python | 📅 2026-08-16.
...
* [Pundit](https://github.com/varvet/pundit) ⭐ 8,522 | 🐛 13 | 🌐 Ruby | 📅 2026-08-27 - Minimal authorization through OO design and pure Ruby classes.
* [CanCanCan](https://github.com/CanCanCommunity/cancancan) ⭐ 5,686 | 🐛 92 | 🌐 Ruby | 📅 2026-08-09 - Authorization for Ruby on Rails.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 59 | 🌐 Go | 📅 2026-08-27 - Open-source authorization layer with a Ruby SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Composio](https://github.com/ComposioHQ/composio) ⭐ 29,900 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-27 - Hosted integration platform with managed OAuth and tool calling for 1000+ apps.
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,615 | 🐛 107 | 🌐 TypeScript | 📅 2026-08-27 - Open-source OAuth and API key handling for 700+ APIs with token refresh and a unified API for agent workloads.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 59 | 🌐 Go | 📅 2026-08-27 - Open-source, policy-based authorization for AI agents, agentic workflows, and MCP servers, with fine-grained access control and full decision logging at runtime.
* [Arcade](https://github.com/ArcadeAI/arcade-ai) ⭐ 1,009 | 🐛 24 | 🌐 Python | 📅 2026-08-27 - Tool-calling platform with user approvals and authenticated actions for AI agents.
* [authsome](https://github.com/agentrhq/authsome) ⭐ 83 | 🐛 11 | 🌐 Python | 📅 2026-07-24 - Local-first credential broker for AI agents with an encrypted local vault and HTTPS proxy injection; no hosted service required.
