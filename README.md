...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,675 | 🐛 118 | 🌐 Go | 📅 2026-08-24 - The Single Sign-On Multi-Factor portal for web apps.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,842 | 🐛 1,132 | 🌐 Go | 📅 2026-08-24 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Logto](https://github.com/logto-io/logto) ⭐ 14,455 | 🐛 181 | 🌐 TypeScript | 📅 2026-08-24 - An IAM infrastructure with AuthN, AuthZ, MFA, SSO, user management, and multi-tenancy features, supporting OAuth 2.0, OIDC, and SAML.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,262 | 🐛 105 | 🌐 Go | 📅 2026-08-22 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,496 | 🐛 94 | 🌐 Go | 📅 2026-07-29 - OpenID Connect certified OAuth2 server.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,842 | 🐛 1,132 | 🌐 Go | 📅 2026-08-24 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,262 | 🐛 105 | 🌐 Go | 📅 2026-08-22 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
...
* [OIDC](https://github.com/caos/oidc) ⭐ 1,871 | 🐛 45 | 🌐 Go | 📅 2026-08-24 - OpenID Connect Library (client and server) for Go
...
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,449 | 🐛 5 | 🌐 Java | 📅 2026-08-23 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
* [pac4j](https://github.com/pac4j/pac4j) ⭐ 2,520 | 🐛 4 | 🌐 Java | 📅 2026-08-24 - Security engine for Java (authentication, authorization, multi frameworks): OAuth, CAS, SAML, OpenID Connect, LDAP, JWT.
...
* [client-certificate-auth](https://github.com/tgies/client-certificate-auth) ⭐ 80 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-24 - Mutual TLS (mTLS) client certificate authentication middleware for Node.js with reverse proxy support, composable verification callbacks, and X.509 certificate parsing.
...
* [Python Social Auth](https://github.com/python-social-auth/social-core) ⭐ 919 | 🐛 54 | 🌐 Python | 📅 2026-08-22 - Easy to setup social authentication/registration mechanism with support for several frameworks and auth providers.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,552 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a .NET SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,342 | 🐛 38 | 🌐 Go | 📅 2026-08-21 - Authorization library that supports access control models like ACL, RBAC, ABAC in Golang.
* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,842 | 🐛 1,132 | 🌐 Go | 📅 2026-08-24 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,986 | 🐛 149 | 🌐 Go | 📅 2026-08-21 - Open-source implementation of the Zanzibar paper, a performant database for fine-grained permissions.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,552 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Go SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [OIDC](https://github.com/zitadel/oidc) ⭐ 1,871 | 🐛 45 | 🌐 Go | 📅 2026-08-24 - OpenID Connect Library (client and server) for Go
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,552 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Rust SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,552 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Java SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,449 | 🐛 5 | 🌐 Java | 📅 2026-08-23 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,552 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a JavaScript/Node.js SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [laravel-permission](https://github.com/spatie/laravel-permission) ⭐ 12,962 | 🐛 5 | 🌐 PHP | 📅 2026-08-24 - Allows you to manage user permissions and roles in a database.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,552 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a PHP SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,552 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Python SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,552 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Ruby SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Composio](https://github.com/ComposioHQ/composio) ⭐ 29,855 | 🐛 81 | 🌐 TypeScript | 📅 2026-08-24 - Hosted integration platform with managed OAuth and tool calling for 1000+ apps.
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,573 | 🐛 103 | 🌐 TypeScript | 📅 2026-08-24 - Open-source OAuth and API key handling for 700+ APIs with token refresh and a unified API for agent workloads.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,552 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source, policy-based authorization for AI agents, agentic workflows, and MCP servers, with fine-grained access control and full decision logging at runtime.
* [Arcade](https://github.com/ArcadeAI/arcade-ai) ⭐ 1,010 | 🐛 17 | 🌐 Python | 📅 2026-08-22 - Tool-calling platform with user approvals and authenticated actions for AI agents.
