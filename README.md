...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,638 | 🐛 130 | 🌐 Go | 📅 2026-08-21 - The Single Sign-On Multi-Factor portal for web apps.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,804 | 🐛 1,140 | 🌐 Go | 📅 2026-08-20 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Logto](https://github.com/logto-io/logto) ⭐ 14,403 | 🐛 185 | 🌐 TypeScript | 📅 2026-08-20 - An IAM infrastructure with AuthN, AuthZ, MFA, SSO, user management, and multi-tenancy features, supporting OAuth 2.0, OIDC, and SAML.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,238 | 🐛 102 | 🌐 Go | 📅 2026-08-21 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [NanoIDP](https://github.com/cdelmonte-zg/nanoidp) ⭐ 22 | 🐛 7 | 🌐 Python | 📅 2026-08-20 - Local development Identity Provider for testing OAuth2, OpenID Connect, and SAML flows without running a full IAM stack.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,488 | 🐛 94 | 🌐 Go | 📅 2026-07-29 - OpenID Connect certified OAuth2 server.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,804 | 🐛 1,140 | 🌐 Go | 📅 2026-08-20 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,238 | 🐛 102 | 🌐 Go | 📅 2026-08-21 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [Ory Kratos](https://github.com/ory/kratos) ⭐ 13,834 | 🐛 222 | 🌐 Go | 📅 2026-07-29 - API-first Identity and User Management system built for cloud applications.
* [Ory Oathkeeper](https://github.com/ory/oathkeeper) ⭐ 3,593 | 🐛 108 | 🌐 Go | 📅 2026-07-27 - Identity/Access proxy inspired by the BeyondCorp/Zero-Trust white paper.
* [Ory Fosite](https://github.com/ory/fosite) ⭐ 2,611 | 🐛 60 | 🌐 Go | 📅 2025-11-20 - Extensible OAuth 2.0 and OpenID Connect SDK for Golang.
* [OIDC](https://github.com/caos/oidc) ⭐ 1,869 | 🐛 43 | 🌐 Go | 📅 2026-08-18 - OpenID Connect Library (client and server) for Go
...
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,450 | 🐛 6 | 🌐 Java | 📅 2026-08-20 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
* [pac4j](https://github.com/pac4j/pac4j) ⭐ 2,520 | 🐛 6 | 🌐 Java | 📅 2026-08-20 - Security engine for Java (authentication, authorization, multi frameworks): OAuth, CAS, SAML, OpenID Connect, LDAP, JWT.
...
* [client-certificate-auth](https://github.com/tgies/client-certificate-auth) ⭐ 80 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-18 - Mutual TLS (mTLS) client certificate authentication middleware for Node.js with reverse proxy support, composable verification callbacks, and X.509 certificate parsing.
...
* [Python Social Auth](https://github.com/python-social-auth/social-core) ⭐ 918 | 🐛 54 | 🌐 Python | 📅 2026-08-20 - Easy to setup social authentication/registration mechanism with support for several frameworks and auth providers.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,547 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a .NET SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,332 | 🐛 42 | 🌐 Go | 📅 2026-08-20 - Authorization library that supports access control models like ACL, RBAC, ABAC in Golang.
* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,804 | 🐛 1,140 | 🌐 Go | 📅 2026-08-20 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,978 | 🐛 149 | 🌐 Go | 📅 2026-08-21 - Open-source implementation of the Zanzibar paper, a performant database for fine-grained permissions.
* [Ory Keto](https://github.com/ory/keto) ⭐ 5,388 | 🐛 73 | 🌐 Go | 📅 2026-08-18 - Access control server capable of solving complex use cases (multi-tenant, attribute-based access control, etc.) with access control policies.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,547 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a Go SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Ladon](https://github.com/ory/ladon) ⭐ 2,458 | 🐛 2 | 🌐 Go | 📅 2025-10-22 - SDK for access control policies: authorization for the microservice and IoT age.
* [OIDC](https://github.com/zitadel/oidc) ⭐ 1,869 | 🐛 43 | 🌐 Go | 📅 2026-08-18 - OpenID Connect Library (client and server) for Go
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,547 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a Rust SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,547 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a Java SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,450 | 🐛 6 | 🌐 Java | 📅 2026-08-20 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,547 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a JavaScript/Node.js SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [laravel-permission](https://github.com/spatie/laravel-permission) ⭐ 12,959 | 🐛 4 | 🌐 PHP | 📅 2026-07-03 - Allows you to manage user permissions and roles in a database.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,547 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a PHP SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,547 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a Python SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,547 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a Ruby SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Composio](https://github.com/ComposioHQ/composio) ⭐ 29,799 | 🐛 62 | 🌐 TypeScript | 📅 2026-08-21 - Hosted integration platform with managed OAuth and tool calling for 1000+ apps.
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,524 | 🐛 119 | 🌐 TypeScript | 📅 2026-08-20 - Open-source OAuth and API key handling for 700+ APIs with token refresh and a unified API for agent workloads.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,547 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - Open-source, policy-based authorization for AI agents, agentic workflows, and MCP servers, with fine-grained access control and full decision logging at runtime.
* [Arcade](https://github.com/ArcadeAI/arcade-ai) ⭐ 1,008 | 🐛 14 | 🌐 Python | 📅 2026-08-21 - Tool-calling platform with user approvals and authenticated actions for AI agents.
...
This project is licensed under the [CC0-1.0 license](https://github.com/casbin/awesome-auth/blob/master/LICENSE) ⭐ 1,215 | 🐛 5 | 🌐 Go | 📅 2026-08-20.
