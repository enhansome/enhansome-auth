...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,682 | 🐛 120 | 🌐 Go | 📅 2026-08-25 - The Single Sign-On Multi-Factor portal for web apps.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,845 | 🐛 1,132 | 🌐 Go | 📅 2026-08-24 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Logto](https://github.com/logto-io/logto) ⭐ 14,455 | 🐛 181 | 🌐 TypeScript | 📅 2026-08-25 - An IAM infrastructure with AuthN, AuthZ, MFA, SSO, user management, and multi-tenancy features, supporting OAuth 2.0, OIDC, and SAML.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,265 | 🐛 108 | 🌐 Go | 📅 2026-08-22 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
...
* [OIDC](https://github.com/caos/oidc) ⭐ 1,872 | 🐛 45 | 🌐 Go | 📅 2026-08-24 - OpenID Connect Library (client and server) for Go
...
* [client-certificate-auth](https://github.com/tgies/client-certificate-auth) ⭐ 80 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-24 - Mutual TLS (mTLS) client certificate authentication middleware for Node.js with reverse proxy support, composable verification callbacks, and X.509 certificate parsing.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a .NET SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,345 | 🐛 38 | 🌐 Go | 📅 2026-08-21 - Authorization library that supports access control models like ACL, RBAC, ABAC in Golang.
* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,845 | 🐛 1,132 | 🌐 Go | 📅 2026-08-24 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Go SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [OIDC](https://github.com/zitadel/oidc) ⭐ 1,872 | 🐛 45 | 🌐 Go | 📅 2026-08-24 - OpenID Connect Library (client and server) for Go
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Rust SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Java SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,450 | 🐛 5 | 🌐 Java | 📅 2026-08-23 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a JavaScript/Node.js SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a PHP SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Python SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Ruby SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Composio](https://github.com/ComposioHQ/composio) ⭐ 29,864 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-25 - Hosted integration platform with managed OAuth and tool calling for 1000+ apps.
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,580 | 🐛 107 | 🌐 TypeScript | 📅 2026-08-24 - Open-source OAuth and API key handling for 700+ APIs with token refresh and a unified API for agent workloads.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-24 - Open-source, policy-based authorization for AI agents, agentic workflows, and MCP servers, with fine-grained access control and full decision logging at runtime.
