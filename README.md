...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,644 | 🐛 118 | 🌐 Go | 📅 2026-08-22 - The Single Sign-On Multi-Factor portal for web apps.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,820 | 🐛 1,142 | 🌐 Go | 📅 2026-08-21 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Logto](https://github.com/logto-io/logto) ⭐ 14,412 | 🐛 183 | 🌐 TypeScript | 📅 2026-08-21 - An IAM infrastructure with AuthN, AuthZ, MFA, SSO, user management, and multi-tenancy features, supporting OAuth 2.0, OIDC, and SAML.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,247 | 🐛 103 | 🌐 Go | 📅 2026-08-21 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [NanoIDP](https://github.com/cdelmonte-zg/nanoidp) ⭐ 22 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Local development Identity Provider for testing OAuth2, OpenID Connect, and SAML flows without running a full IAM stack.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,489 | 🐛 94 | 🌐 Go | 📅 2026-07-29 - OpenID Connect certified OAuth2 server.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,820 | 🐛 1,142 | 🌐 Go | 📅 2026-08-21 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,247 | 🐛 103 | 🌐 Go | 📅 2026-08-21 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [Ory Kratos](https://github.com/ory/kratos) ⭐ 13,837 | 🐛 224 | 🌐 Go | 📅 2026-07-29 - API-first Identity and User Management system built for cloud applications.
...
* [OIDC](https://github.com/caos/oidc) ⭐ 1,869 | 🐛 43 | 🌐 Go | 📅 2026-08-21 - OpenID Connect Library (client and server) for Go
...
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,450 | 🐛 7 | 🌐 Java | 📅 2026-08-21 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
...
* [Python Social Auth](https://github.com/python-social-auth/social-core) ⭐ 918 | 🐛 54 | 🌐 Python | 📅 2026-08-21 - Easy to setup social authentication/registration mechanism with support for several frameworks and auth providers.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,548 | 🐛 58 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a .NET SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,334 | 🐛 38 | 🌐 Go | 📅 2026-08-21 - Authorization library that supports access control models like ACL, RBAC, ABAC in Golang.
* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,820 | 🐛 1,142 | 🌐 Go | 📅 2026-08-21 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,979 | 🐛 149 | 🌐 Go | 📅 2026-08-21 - Open-source implementation of the Zanzibar paper, a performant database for fine-grained permissions.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,548 | 🐛 58 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a Go SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [OIDC](https://github.com/zitadel/oidc) ⭐ 1,869 | 🐛 43 | 🌐 Go | 📅 2026-08-21 - OpenID Connect Library (client and server) for Go
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,548 | 🐛 58 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a Rust SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,548 | 🐛 58 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a Java SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,450 | 🐛 7 | 🌐 Java | 📅 2026-08-21 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,548 | 🐛 58 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a JavaScript/Node.js SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,548 | 🐛 58 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a PHP SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,548 | 🐛 58 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a Python SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Flask-RBAC](https://github.com/shonenada/flask-rbac) ⭐ 233 | 🐛 15 | 🌐 Python | 📅 2026-02-20 - Adds RBAC support to [Flask](https://github.com/pallets/flask) ⭐ 72,133 | 🐛 3 | 🌐 Python | 📅 2026-08-16.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,548 | 🐛 58 | 🌐 Go | 📅 2026-08-18 - Open-source authorization layer with a Ruby SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Composio](https://github.com/ComposioHQ/composio) ⭐ 29,810 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-22 - Hosted integration platform with managed OAuth and tool calling for 1000+ apps.
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,544 | 🐛 107 | 🌐 TypeScript | 📅 2026-08-21 - Open-source OAuth and API key handling for 700+ APIs with token refresh and a unified API for agent workloads.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,548 | 🐛 58 | 🌐 Go | 📅 2026-08-18 - Open-source, policy-based authorization for AI agents, agentic workflows, and MCP servers, with fine-grained access control and full decision logging at runtime.
* [Arcade](https://github.com/ArcadeAI/arcade-ai) ⭐ 1,008 | 🐛 14 | 🌐 Python | 📅 2026-08-22 - Tool-calling platform with user approvals and authenticated actions for AI agents.
...
This project is licensed under the [CC0-1.0 license](https://github.com/casbin/awesome-auth/blob/master/LICENSE) ⭐ 1,215 | 🐛 6 | 🌐 Go | 📅 2026-08-21.
