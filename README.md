...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,667 | 🐛 120 | 🌐 Go | 📅 2026-08-24 - The Single Sign-On Multi-Factor portal for web apps.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,837 | 🐛 1,144 | 🌐 Go | 📅 2026-08-21 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Logto](https://github.com/logto-io/logto) ⭐ 14,448 | 🐛 184 | 🌐 TypeScript | 📅 2026-08-22 - An IAM infrastructure with AuthN, AuthZ, MFA, SSO, user management, and multi-tenancy features, supporting OAuth 2.0, OIDC, and SAML.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,257 | 🐛 103 | 🌐 Go | 📅 2026-08-22 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [NanoIDP](https://github.com/cdelmonte-zg/nanoidp) ⭐ 22 | 🐛 16 | 🌐 Python | 📅 2026-08-23 - Local development Identity Provider for testing OAuth2, OpenID Connect, and SAML flows without running a full IAM stack.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,493 | 🐛 94 | 🌐 Go | 📅 2026-07-29 - OpenID Connect certified OAuth2 server.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,837 | 🐛 1,144 | 🌐 Go | 📅 2026-08-21 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,257 | 🐛 103 | 🌐 Go | 📅 2026-08-22 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [Ory Kratos](https://github.com/ory/kratos) ⭐ 13,844 | 🐛 224 | 🌐 Go | 📅 2026-07-29 - API-first Identity and User Management system built for cloud applications.
...
* [OIDC](https://github.com/caos/oidc) ⭐ 1,871 | 🐛 44 | 🌐 Go | 📅 2026-08-21 - OpenID Connect Library (client and server) for Go
...
* [pac4j](https://github.com/pac4j/pac4j) ⭐ 2,520 | 🐛 5 | 🌐 Java | 📅 2026-08-23 - Security engine for Java (authentication, authorization, multi frameworks): OAuth, CAS, SAML, OpenID Connect, LDAP, JWT.
...
* [client-certificate-auth](https://github.com/tgies/client-certificate-auth) ⭐ 80 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-23 - Mutual TLS (mTLS) client certificate authentication middleware for Node.js with reverse proxy support, composable verification callbacks, and X.509 certificate parsing.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 62 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a .NET SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,338 | 🐛 38 | 🌐 Go | 📅 2026-08-21 - Authorization library that supports access control models like ACL, RBAC, ABAC in Golang.
* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,837 | 🐛 1,144 | 🌐 Go | 📅 2026-08-21 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,985 | 🐛 149 | 🌐 Go | 📅 2026-08-21 - Open-source implementation of the Zanzibar paper, a performant database for fine-grained permissions.
* [Ory Keto](https://github.com/ory/keto) ⭐ 5,389 | 🐛 73 | 🌐 Go | 📅 2026-08-21 - Access control server capable of solving complex use cases (multi-tenant, attribute-based access control, etc.) with access control policies.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 62 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Go SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [OIDC](https://github.com/zitadel/oidc) ⭐ 1,871 | 🐛 44 | 🌐 Go | 📅 2026-08-21 - OpenID Connect Library (client and server) for Go
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 62 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Rust SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 62 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Java SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,450 | 🐛 5 | 🌐 Java | 📅 2026-08-23 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 62 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a JavaScript/Node.js SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [laravel-permission](https://github.com/spatie/laravel-permission) ⭐ 12,962 | 🐛 4 | 🌐 PHP | 📅 2026-07-03 - Allows you to manage user permissions and roles in a database.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 62 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a PHP SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 62 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Python SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Flask-RBAC](https://github.com/shonenada/flask-rbac) ⭐ 233 | 🐛 15 | 🌐 Python | 📅 2026-02-20 - Adds RBAC support to [Flask](https://github.com/pallets/flask) ⭐ 72,146 | 🐛 3 | 🌐 Python | 📅 2026-08-16.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 62 | 🌐 Go | 📅 2026-08-24 - Open-source authorization layer with a Ruby SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Composio](https://github.com/ComposioHQ/composio) ⭐ 29,850 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-23 - Hosted integration platform with managed OAuth and tool calling for 1000+ apps.
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,569 | 🐛 103 | 🌐 TypeScript | 📅 2026-08-24 - Open-source OAuth and API key handling for 700+ APIs with token refresh and a unified API for agent workloads.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 62 | 🌐 Go | 📅 2026-08-24 - Open-source, policy-based authorization for AI agents, agentic workflows, and MCP servers, with fine-grained access control and full decision logging at runtime.
...
This project is licensed under the [CC0-1.0 license](https://github.com/casbin/awesome-auth/blob/master/LICENSE) ⭐ 1,215 | 🐛 5 | 🌐 Go | 📅 2026-08-23.
