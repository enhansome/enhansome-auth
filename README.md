...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,684 | 🐛 116 | 🌐 Go | 📅 2026-08-25 - The Single Sign-On Multi-Factor portal for web apps.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,846 | 🐛 1,132 | 🌐 Go | 📅 2026-08-24 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Logto](https://github.com/logto-io/logto) ⭐ 14,456 | 🐛 179 | 🌐 TypeScript | 📅 2026-08-25 - An IAM infrastructure with AuthN, AuthZ, MFA, SSO, user management, and multi-tenancy features, supporting OAuth 2.0, OIDC, and SAML.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,267 | 🐛 108 | 🌐 Go | 📅 2026-08-22 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [NanoIDP](https://github.com/cdelmonte-zg/nanoidp) ⭐ 22 | 🐛 14 | 🌐 Python | 📅 2026-08-24 - Local development Identity Provider for testing OAuth2, OpenID Connect, and SAML flows without running a full IAM stack.
...
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,846 | 🐛 1,132 | 🌐 Go | 📅 2026-08-24 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,267 | 🐛 108 | 🌐 Go | 📅 2026-08-22 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [Ory Kratos](https://github.com/ory/kratos) ⭐ 13,846 | 🐛 224 | 🌐 Go | 📅 2026-07-29 - API-first Identity and User Management system built for cloud applications.
...
* [OIDC](https://github.com/caos/oidc) ⭐ 1,872 | 🐛 46 | 🌐 Go | 📅 2026-08-24 - OpenID Connect Library (client and server) for Go
...
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,450 | 🐛 5 | 🌐 Java | 📅 2026-08-23 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
* [pac4j](https://github.com/pac4j/pac4j) ⭐ 2,520 | 🐛 5 | 🌐 Java | 📅 2026-08-24 - Security engine for Java (authentication, authorization, multi frameworks): OAuth, CAS, SAML, OpenID Connect, LDAP, JWT.
...
* [Python Social Auth](https://github.com/python-social-auth/social-core) ⭐ 919 | 🐛 55 | 🌐 Python | 📅 2026-08-22 - Easy to setup social authentication/registration mechanism with support for several frameworks and auth providers.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-25 - Open-source authorization layer with a .NET SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,344 | 🐛 38 | 🌐 Go | 📅 2026-08-21 - Authorization library that supports access control models like ACL, RBAC, ABAC in Golang.
* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,846 | 🐛 1,132 | 🌐 Go | 📅 2026-08-24 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,987 | 🐛 150 | 🌐 Go | 📅 2026-08-24 - Open-source implementation of the Zanzibar paper, a performant database for fine-grained permissions.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-25 - Open-source authorization layer with a Go SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [OIDC](https://github.com/zitadel/oidc) ⭐ 1,872 | 🐛 46 | 🌐 Go | 📅 2026-08-24 - OpenID Connect Library (client and server) for Go
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-25 - Open-source authorization layer with a Rust SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-25 - Open-source authorization layer with a Java SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,450 | 🐛 5 | 🌐 Java | 📅 2026-08-23 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-25 - Open-source authorization layer with a JavaScript/Node.js SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [pundit-ts](https://github.com/fatihky/pundit-ts) ⭐ 97 | 🐛 0 | 🌐 TypeScript | 📅 2025-10-22 - Fully type-safe authorization library inspired by awesome [pundit](https://github.com/varvet/pundit) ⭐ 8,522 | 🐛 15 | 🌐 Ruby | 📅 2026-08-02 gem. Can be used for RBAC, ABAC access control models or any other model you wish.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-25 - Open-source authorization layer with a PHP SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-25 - Open-source authorization layer with a Python SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Flask-RBAC](https://github.com/shonenada/flask-rbac) ⭐ 233 | 🐛 15 | 🌐 Python | 📅 2026-02-20 - Adds RBAC support to [Flask](https://github.com/pallets/flask) ⭐ 72,147 | 🐛 3 | 🌐 Python | 📅 2026-08-16.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-25 - Open-source authorization layer with a Ruby SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Composio](https://github.com/ComposioHQ/composio) ⭐ 29,866 | 🐛 76 | 🌐 TypeScript | 📅 2026-08-25 - Hosted integration platform with managed OAuth and tool calling for 1000+ apps.
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,581 | 🐛 108 | 🌐 TypeScript | 📅 2026-08-25 - Open-source OAuth and API key handling for 700+ APIs with token refresh and a unified API for agent workloads.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,551 | 🐛 60 | 🌐 Go | 📅 2026-08-25 - Open-source, policy-based authorization for AI agents, agentic workflows, and MCP servers, with fine-grained access control and full decision logging at runtime.
* [Arcade](https://github.com/ArcadeAI/arcade-ai) ⭐ 1,010 | 🐛 18 | 🌐 Python | 📅 2026-08-22 - Tool-calling platform with user approvals and authenticated actions for AI agents.
...
This project is licensed under the [CC0-1.0 license](https://github.com/casbin/awesome-auth/blob/master/LICENSE) ⭐ 1,215 | 🐛 5 | 🌐 Go | 📅 2026-08-24.
