...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,602 | 🐛 127 | 🌐 Go | 📅 2026-08-18 - The Single Sign-On Multi-Factor portal for web apps.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,760 | 🐛 1,126 | 🌐 Go | 📅 2026-08-17 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Logto](https://github.com/logto-io/logto) ⭐ 14,369 | 🐛 186 | 🌐 TypeScript | 📅 2026-08-18 - An IAM infrastructure with AuthN, AuthZ, MFA, SSO, user management, and multi-tenancy features, supporting OAuth 2.0, OIDC, and SAML.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,211 | 🐛 105 | 🌐 Go | 📅 2026-08-16 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,481 | 🐛 93 | 🌐 Go | 📅 2026-07-29 - OpenID Connect certified OAuth2 server.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,760 | 🐛 1,126 | 🌐 Go | 📅 2026-08-17 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,211 | 🐛 105 | 🌐 Go | 📅 2026-08-16 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [Ory Kratos](https://github.com/ory/kratos) ⭐ 13,830 | 🐛 222 | 🌐 Go | 📅 2026-07-29 - API-first Identity and User Management system built for cloud applications.
...
* [OIDC](https://github.com/caos/oidc) ⭐ 1,867 | 🐛 41 | 🌐 Go | 📅 2026-08-17 - OpenID Connect Library (client and server) for Go
...
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,450 | 🐛 6 | 🌐 Java | 📅 2026-08-17 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
* [pac4j](https://github.com/pac4j/pac4j) ⭐ 2,519 | 🐛 3 | 🌐 Java | 📅 2026-08-17 - Security engine for Java (authentication, authorization, multi frameworks): OAuth, CAS, SAML, OpenID Connect, LDAP, JWT.
...
* [client-certificate-auth](https://github.com/tgies/client-certificate-auth) ⭐ 80 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-17 - Mutual TLS (mTLS) client certificate authentication middleware for Node.js with reverse proxy support, composable verification callbacks, and X.509 certificate parsing.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,541 | 🐛 59 | 🌐 Go | 📅 2026-08-17 - Open-source authorization layer with a .NET SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,327 | 🐛 42 | 🌐 Go | 📅 2026-08-13 - Authorization library that supports access control models like ACL, RBAC, ABAC in Golang.
* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,760 | 🐛 1,126 | 🌐 Go | 📅 2026-08-17 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,971 | 🐛 149 | 🌐 Go | 📅 2026-08-17 - Open-source implementation of the Zanzibar paper, a performant database for fine-grained permissions.
* [Ory Keto](https://github.com/ory/keto) ⭐ 5,388 | 🐛 71 | 🌐 Go | 📅 2026-08-17 - Access control server capable of solving complex use cases (multi-tenant, attribute-based access control, etc.) with access control policies.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,541 | 🐛 59 | 🌐 Go | 📅 2026-08-17 - Open-source authorization layer with a Go SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [OIDC](https://github.com/zitadel/oidc) ⭐ 1,867 | 🐛 41 | 🌐 Go | 📅 2026-08-17 - OpenID Connect Library (client and server) for Go
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,541 | 🐛 59 | 🌐 Go | 📅 2026-08-17 - Open-source authorization layer with a Rust SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,541 | 🐛 59 | 🌐 Go | 📅 2026-08-17 - Open-source authorization layer with a Java SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,450 | 🐛 6 | 🌐 Java | 📅 2026-08-17 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,541 | 🐛 59 | 🌐 Go | 📅 2026-08-17 - Open-source authorization layer with a JavaScript/Node.js SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [pundit-ts](https://github.com/fatihky/pundit-ts) ⭐ 97 | 🐛 0 | 🌐 TypeScript | 📅 2025-10-22 - Fully type-safe authorization library inspired by awesome [pundit](https://github.com/varvet/pundit) ⭐ 8,521 | 🐛 15 | 🌐 Ruby | 📅 2026-08-02 gem. Can be used for RBAC, ABAC access control models or any other model you wish.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,541 | 🐛 59 | 🌐 Go | 📅 2026-08-17 - Open-source authorization layer with a PHP SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,541 | 🐛 59 | 🌐 Go | 📅 2026-08-17 - Open-source authorization layer with a Python SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [PyCasbin](https://github.com/casbin/pycasbin) ⭐ 1,761 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - Authorization library that supports access control models like ACL, RBAC, ABAC in Python.
* [Flask-RBAC](https://github.com/shonenada/flask-rbac) ⭐ 233 | 🐛 15 | 🌐 Python | 📅 2026-02-20 - Adds RBAC support to [Flask](https://github.com/pallets/flask) ⭐ 72,125 | 🐛 3 | 🌐 Python | 📅 2026-08-16.
...
* [Pundit](https://github.com/varvet/pundit) ⭐ 8,521 | 🐛 15 | 🌐 Ruby | 📅 2026-08-02 - Minimal authorization through OO design and pure Ruby classes.
* [CanCanCan](https://github.com/CanCanCommunity/cancancan) ⭐ 5,688 | 🐛 93 | 🌐 Ruby | 📅 2026-08-09 - Authorization for Ruby on Rails.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,541 | 🐛 59 | 🌐 Go | 📅 2026-08-17 - Open-source authorization layer with a Ruby SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Composio](https://github.com/ComposioHQ/composio) ⭐ 29,739 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-18 - Hosted integration platform with managed OAuth and tool calling for 1000+ apps.
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,489 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-17 - Open-source OAuth and API key handling for 700+ APIs with token refresh and a unified API for agent workloads.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,541 | 🐛 59 | 🌐 Go | 📅 2026-08-17 - Open-source, policy-based authorization for AI agents, agentic workflows, and MCP servers, with fine-grained access control and full decision logging at runtime.
* [Arcade](https://github.com/ArcadeAI/arcade-ai) ⭐ 1,007 | 🐛 13 | 🌐 Python | 📅 2026-08-15 - Tool-calling platform with user approvals and authenticated actions for AI agents.
...
This project is licensed under the [CC0-1.0 license](https://github.com/casbin/awesome-auth/blob/master/LICENSE) ⭐ 1,214 | 🐛 5 | 🌐 Go | 📅 2026-08-18.
