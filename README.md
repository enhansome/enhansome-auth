...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,723 | 🐛 132 | 🌐 Go | 📅 2026-08-28 - The Single Sign-On Multi-Factor portal for web apps.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,884 | 🐛 1,143 | 🌐 Go | 📅 2026-08-28 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Logto](https://github.com/logto-io/logto) ⭐ 14,474 | 🐛 178 | 🌐 TypeScript | 📅 2026-08-28 - An IAM infrastructure with AuthN, AuthZ, MFA, SSO, user management, and multi-tenancy features, supporting OAuth 2.0, OIDC, and SAML.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,283 | 🐛 116 | 🌐 Go | 📅 2026-08-28 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
...
* [Ory Hydra](https://github.com/ory/hydra) ⭐ 17,507 | 🐛 94 | 🌐 Go | 📅 2026-07-29 - OpenID Connect certified OAuth2 server.
* [ZITADEL](https://github.com/caos/zitadel) ⭐ 14,884 | 🐛 1,143 | 🌐 Go | 📅 2026-08-28 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,283 | 🐛 116 | 🌐 Go | 📅 2026-08-28 - UI-first centralized authentication / Single-Sign-On (SSO) platform supporting OAuth 2.0 / OIDC and SAML.
* [Ory Kratos](https://github.com/ory/kratos) ⭐ 13,854 | 🐛 222 | 🌐 Go | 📅 2026-07-29 - API-first Identity and User Management system built for cloud applications.
...
* [OIDC](https://github.com/caos/oidc) ⭐ 1,875 | 🐛 40 | 🌐 Go | 📅 2026-08-28 - OpenID Connect Library (client and server) for Go
...
* [pac4j](https://github.com/pac4j/pac4j) ⭐ 2,522 | 🐛 1 | 🌐 Java | 📅 2026-08-28 - Security engine for Java (authentication, authorization, multi frameworks): OAuth, CAS, SAML, OpenID Connect, LDAP, JWT.
...
* [client-certificate-auth](https://github.com/tgies/client-certificate-auth) ⭐ 80 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-28 - Mutual TLS (mTLS) client certificate authentication middleware for Node.js with reverse proxy support, composable verification callbacks, and X.509 certificate parsing.
...
* [Python Social Auth](https://github.com/python-social-auth/social-core) ⭐ 919 | 🐛 55 | 🌐 Python | 📅 2026-08-28 - Easy to setup social authentication/registration mechanism with support for several frameworks and auth providers.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 56 | 🌐 Go | 📅 2026-08-28 - Open-source authorization layer with a .NET SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
* [Casbin.NET](https://github.com/casbin/Casbin.NET) ⭐ 1,330 | 🐛 7 | 🌐 C# | 📅 2026-08-15 - Authorization library that supports access control models like ACL, RBAC, ABAC in .NET (C#).
...
* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,884 | 🐛 1,143 | 🌐 Go | 📅 2026-08-28 - Cloud-native Identity & Access Management platform for secure authentication, authorization and identity management.
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,996 | 🐛 146 | 🌐 Go | 📅 2026-08-27 - Open-source implementation of the Zanzibar paper, a performant database for fine-grained permissions.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 56 | 🌐 Go | 📅 2026-08-28 - Open-source authorization layer with a Go SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [OIDC](https://github.com/zitadel/oidc) ⭐ 1,875 | 🐛 40 | 🌐 Go | 📅 2026-08-28 - OpenID Connect Library (client and server) for Go
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 56 | 🌐 Go | 📅 2026-08-28 - Open-source authorization layer with a Rust SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 56 | 🌐 Go | 📅 2026-08-28 - Open-source authorization layer with a Java SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
* [Apache Shiro](https://github.com/apache/shiro) ⭐ 4,452 | 🐛 5 | 🌐 Java | 📅 2026-08-27 - Powerful and easy-to-use Java security framework that performs authentication, authorization, cryptography, and session management.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 56 | 🌐 Go | 📅 2026-08-28 - Open-source authorization layer with a JavaScript/Node.js SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Node-Casbin](https://github.com/casbin/node-casbin) ⭐ 2,916 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-13 - Authorization library that supports access control models like ACL, RBAC, ABAC in Node.js.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 56 | 🌐 Go | 📅 2026-08-28 - Open-source authorization layer with a PHP SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 56 | 🌐 Go | 📅 2026-08-28 - Open-source authorization layer with a Python SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Flask-RBAC](https://github.com/shonenada/flask-rbac) ⭐ 233 | 🐛 15 | 🌐 Python | 📅 2026-02-20 - Adds RBAC support to [Flask](https://github.com/pallets/flask) ⭐ 72,144 | 🐛 3 | 🌐 Python | 📅 2026-08-16.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 56 | 🌐 Go | 📅 2026-08-28 - Open-source authorization layer with a Ruby SDK for RBAC, ABAC, and PBAC policies evaluated at runtime.
...
* [Composio](https://github.com/ComposioHQ/composio) ⭐ 29,915 | 🐛 73 | 🌐 TypeScript | 📅 2026-08-28 - Hosted integration platform with managed OAuth and tool calling for 1000+ apps.
* [Nango](https://github.com/NangoHQ/nango) ⭐ 11,625 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-28 - Open-source OAuth and API key handling for 700+ APIs with token refresh and a unified API for agent workloads.
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 56 | 🌐 Go | 📅 2026-08-28 - Open-source, policy-based authorization for AI agents, agentic workflows, and MCP servers, with fine-grained access control and full decision logging at runtime.
...
This project is licensed under the [CC0-1.0 license](https://github.com/casbin/awesome-auth/blob/master/LICENSE) ⭐ 1,257 | 🐛 5 | 🌐 Go | 📅 2026-08-25.
